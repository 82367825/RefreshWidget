 ...
 * @date 16-7-6
 */
public class RefreshScrollViewWidget extends ScrollView implements RefreshScrollViewInterface{

    private static final String TAG = "RefreshScrollViewWidget";
    ...
    private void init() {
        ...
        mHeaderLayoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        mHeaderView.onRefresh(0);
        addView(mHeaderView, mHeaderLayoutParams);
        
        mFooterView = new FooterTextView(getContext());
        mFooterLayoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
...
//            mFooterView.measure(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    private void makeContentViewToFooter() {
        
    }
    
    private void makeContentViewRestore() {
